...
| `hitMargin`      | `number`                   | `24`      | Extra hit-area in px on every side of the wrapper. Lets you overshoot the visible edge and still pin the back fully revealed. Bump to 80–120 to make the surrounding cell the hit target. |
